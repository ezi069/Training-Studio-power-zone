...
const Trainers = () => (
  <section css={styles} className="trainers" id="trainers">
    ...
    <Icon />
    <p>
      Our certified trainers are dedicated to helping you achieve your fitness goals with expert guidance.{" "}
      <br />
      Whether you're a beginner or an athlete, they provide personalized coaching and motivation to keep you on track.
    </p>
    <Container>
      <TrainerCard
